...
class NullableTest {
    ...
    void getValueTest() {
        ...
        Assertions.assertNotNull(nullable1.get());
        Assertions.assertNull(nullable2.get());
    }
    ...
    void mapNullableWithNonNullValueTest() {
        ...
        Assertions.assertNotNull(integerNullable.get());
    }
    ...
    void mapNullableWithNullValueTest() {
        ...
        Assertions.assertNotNull(integerNullable);
        Assertions.assertNull(integerNullable.get());
    }
    ...
    void orNullableWithNonNullValueTest() {
        ...
        Assertions.assertNotNull(nullable3.get());
        Assertions.assertEquals("abc", nullable3.get());
    }
    ...
    void orNullableWithNullValueTest() {
        ...
        Assertions.assertNotNull(nullable3);
        Assertions.assertNotNull(nullable3.get());
        Assertions.assertEquals("def", nullable3.get());
    }
