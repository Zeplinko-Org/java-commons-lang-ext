 ...
 * is present, {@code isNull()} will return {@code false} and {@code get()} will
 * return the value.
 *
...
public final class Nullable<T> {
    ...
    /**
     * Returns a {@code Nullable} with the specified present non-null value.
     *
     ...
     *
     * @return the non-null {@code value} held by this {@code Nullable}, or
